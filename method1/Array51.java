/*
31. Suppose X. Y, Z are arrays of integers of size M, N, and M + N respectively. The numbers in array X and Y appear in descending order. Write a java program to produce
...
class Array51{
    public void num(int a[],int b[],int c[]){
		...
		System.out.println("after merge two array arrange descending order");
		for(i=0;i<c.length;i++){
